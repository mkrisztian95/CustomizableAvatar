...
var defaultFontSize = 32.0
var defaultFontName = "Helvetica"
var defaultStartColor = "#FF0000"
var defaultEndColor = "#FFA500"
var defaultBackgroundColor = "#00ff00"
...
public final class ConstructorToolbar: UIView {
    ...
    private var selectedFontName = defaultFontName
    private var selectedStartColor = defaultStartColor
    private var selectedEndColor = defaultEndColor
    private var selectedBackgroundColor = defaultBackgroundColor
    private var selectedTextColor = defaultTextColor
    private var selectedName = defaultName

    public var delegate: ConstructorToolbarProtocol?

    private func getColorWell() -> UIColorWell {
    ...
    private func getColorStack(with subviews: [UIView]) -> UIStackView {
    ...
    private func getIndicatorLabel(with text: String) -> UILabel {
        let label = UILabel()
